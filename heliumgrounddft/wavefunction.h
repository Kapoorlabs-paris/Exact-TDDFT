...
complex<double> trace(grid g,double box, const wavefunction &wf, const wavefunction &wfm);

complex<double> traceion(grid g,double box, const wavefunction &wf,double k);
 ...
 wavefunction alog(grid g, double deltat);
    ...
    wavefunction phasekohnshamorbital(grid gone, grid g, const wavefunction &wf);
...
complex<double> tracenode(grid g,double box,const wavefunction &wf);
...
wavefunction staticpotential(grid g,const wavefunction &dens);
